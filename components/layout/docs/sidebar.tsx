        ...
        <>
          ...
          >
            ...
            <aside
              ...
              className={cn(
                "bg-fd-card absolute inset-y-0 start-0 flex w-full flex-col items-end border-e text-sm duration-250 *:w-(--fd-sidebar-width)",
                collapsed && [
          ...
          <div
            data-sidebar-panel=""
            className={cn(
              "bg-fd-muted text-fd-muted-foreground fixed start-4 top-[calc(--spacing(4)+var(--fd-toc-popover-height))] z-10 flex rounded-xl border p-0.5 shadow-lg transition-opacity",
