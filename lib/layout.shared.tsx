...
import { Heart, UserStar, Wrench } from "lucide-react";
  ...
  return {
    ...
    links: [
      ...
      },
      {
        ...
        label: "TrustPilot",
        text: "TrustPilot",
        url: "https://www.trustpilot.com/review/jointhis.party",
        icon: <UserStar fill="currentcolor" />,
        on: "menu",
      },
      {
        type: "icon",
        label: "AlternativeTo",
        text: "AlternativeTo",
        url: "https://alternativeto.net/software/jointhis-party--jointhis-proxy/about/",
